...
public class mainClass {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException{
		...
		//loop to find a optimal solution
		int max = 0;
		...
		for (int i=0; i< 10000; i++){
			...
			CourseRegister randomRegister = new CourseRegister(students,sections,courses);
			randomRegister.generateRandom();
			if (randomRegister.getTotal() > max){
				max = randomRegister.getTotal();
				finalSection = randomRegister.getSections();
				finalStudents = randomRegister.getStudents();
				finalCourses = randomRegister.getCourses();
